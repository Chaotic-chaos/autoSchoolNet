#!/bin/sh
a=`curl http://222.197.192.59:9090/zportal/logout --data "userName=!!!&userIp=10.33.130.72&deviceIp=172.16.32.254&service.id=&autoLoginFlag=false&userMac=f460e2fe1020&operationType=&isMacFastAuth=false"`
